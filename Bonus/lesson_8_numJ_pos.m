...
% -------- Forward kinematics chain (store frames) --------
T = eye(4);
o = zeros(3,7);         
z = zeros(3,7);         
o(:,1) = [0;0;0];
...
% Tooltip position (shaft along +z6)
p_tool = T06(1:3,1:3)*[0;0;shaft_len] + T06(1:3,4);

% -------- Analytic position Jacobian J (3x6) --------
J = zeros(3,6);
for i = 1:6
    zi_1 = z(:,i);          
    oi_1 = o(:,i);          
    J(:,i) = cross(zi_1, p_tool - oi_1);
end
